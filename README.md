...
1. Folder public: 1.1. index.html
2. Folder src (Source)
3. src/assets
4. src/components: 4.1. TaskList.jsx, 4.2. CourseForm.jsx
5. src/pages: 5.1. CourseDetailPage.jsx
6. src/services (atau src/api): 6.1. courseService.js dengan fungsi getAllCourses(), createCourse(data), deleteCourse(id).
7. src/utils (Utilities)
8. App.jsx dan main.jsx
9. package.json
